...
keys = [
   ...
   Key([mod], "p", lazy.spawn(terminal), desc="Launch kitty terminal"),
   Key([mod], "b", lazy.spawn(browser), desc="Launch firefox"),
   Key([mod], "x", lazy.spawn("krusader"), desc="Launch krusader"),
]
...
screens = [
    Screen(
        top=bar.Bar(
            ...
            24,
            wallpaper='/home/randaegs/Pictures/Wallpapers/zfirvnutwp2a1.jpg',
            wallpaper_mode='fit'
   ...
   Screen(
       top=bar.Bar(
         ...
         24,
         wallpaper='~/Pictures/Wallpapers/wallpaperflare.com_wallpaper(2).jpg',
         wallpaper_mode='fit'
       )
   )
]
